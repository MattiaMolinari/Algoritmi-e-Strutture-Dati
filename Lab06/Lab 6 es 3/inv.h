...
/* controlla che le singole stat non scendano al di sotto del valore voluto */
int stat_single(int singlestat, int soglia);

/* aggiorna le statisiche base dati i bonus/malus */
...
/* ritorna il campo nome di un oggetto dell'inventario */
